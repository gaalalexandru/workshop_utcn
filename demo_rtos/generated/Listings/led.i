...
void RGB_Led_Init(void)
{
  ...
  (*((volatile unsigned long *)0x40025524)) |= 0x1F;  
	...
	GPIOPadConfigSet(0x40025000, 0x00000002|0x00000004|0x00000008, 0x00000001,0x00000008);  
...
void Led_toggle(unsigned char color)
{
	...
	if(status) {
		GPIOPinWrite(0x40025000, color, color);	
	}
	else {
		GPIOPinWrite(0x40025000, color, 0);  
	}
	status ^= 1;  
}
...
void RGB_PWM_Init(unsigned long PWM_Period)
{
	...
	PWMPulseWidthSet(0x40029000, 0x000000C5, (50*(PWMGenPeriodGet(0x40029000,0x000000C0))/100));
	PWMGenEnable(0x40029000, 0x000000C0);  
	PWMPulseWidthSet(0x40029000, 0x00000106, (50*(PWMGenPeriodGet(0x40029000,0x00000100))/100));
	PWMGenEnable(0x40029000, 0x00000100);	 
	PWMPulseWidthSet(0x40029000, 0x00000107, (99*(PWMGenPeriodGet(0x40029000,0x00000100))/100));
	PWMGenEnable(0x40029000, 0x00000100);  
...
void RED_PWM_DutyCycle(unsigned long duty_cycle)
{
	...
	else
	{
		...
		PWMPulseWidthSet(0x40029000, 0x000000C5, (duty_cycle*(PWMGenPeriodGet(0x40029000,0x000000C0))/100));	
		PWMGenEnable(0x40029000, 0x000000C0); 
		PWMOutputState(0x40029000, 0x00000020 , (1)); 
	}
}
...
if(duty_cycle == 0)
	...
	else
	{
		...
		PWMPulseWidthSet(0x40029000, 0x00000107, (duty_cycle*(PWMGenPeriodGet(0x40029000,0x00000100))/100));	
		PWMGenEnable(0x40029000, 0x00000100); 
...
if(duty_cycle == 0)
	...
	else
	{
		...
		PWMPulseWidthSet(0x40029000, 0x00000106, (duty_cycle*(PWMGenPeriodGet(0x40029000,0x00000100))/100));	
		PWMGenEnable(0x40029000, 0x00000100); 
		PWMOutputState(0x40029000, 0x00000040 , (1)); 
	}
}	
